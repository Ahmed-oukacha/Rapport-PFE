...
#let runtime-color = rgb("#7C3AED")
#let success-color = rgb("#16A34A")
#let warning-color = rgb("#EA580C")
#let muted-color = rgb("#64748B")

#let border-color = rgb("#CBD5E1")
#let background-soft = rgb("#F8FAFC")
...
#show heading.where(level: 1): it => {
  ...
  line(
    length: 100%,
    stroke: (paint: accent-color, thickness: 1.2pt),
  )
...
#let paris-saclay-thesis(
  ...
  grid(
    ...
    [
      #rect(
        fill: prune,
        width: 80%,// 100% of rectangle_width,
        height: 100%
      )
  ...
  width: 11cm
    ...
    [ // right part of the grid
      ...
      #align(center)[
  #image("img/INTERFACES.png", width: 29.4%*30cm)
]
      ...
      #grid(
        ...
        [],
        [
          #text(size: 14pt, fill: prune)[*Encadré par :*]\
